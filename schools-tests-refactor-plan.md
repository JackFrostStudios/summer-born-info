...
- [x] Step 3: Improve GetAllSchoolsTests to assert returned school data and cursor pagination behavior.
- [x] Step 4: Re-run the affected tests to confirm the stronger assertions pass.
